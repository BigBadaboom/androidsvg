...
@Config(manifest=Config.NONE, shadows={MockCanvas.class, MockPath.class, MockPicture.class, MockPaint.class})
public class RenderToPictureTest
{
   ...
   public void renderToPicture() throws SVGParseException
   {
      ...
      assertEquals("drawPath('M 0 0 L 200 0 L 200 100 L 0 100 L 0 0 Z', Paint(color:#ff008000; f:ANTI_ALIAS|LINEAR_TEXT|SUBPIXEL_TEXT; h:OFF; s:FILL; tf:android.graphics.Typeface@0; ts:16))", ops.get(3));
   }
